...
``my_ocr.adapters.outbound.config.layout_profile._load_model_labels`` directly inside each
test case.
"""
...
def _stub_resolve_layout_profile(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    """
    import my_ocr.adapters.outbound.config.layout_profile as _lp_mod
