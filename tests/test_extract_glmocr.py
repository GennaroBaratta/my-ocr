...
from free_doc_extract.experimental.extract_glmocr import (
...
def test_extract_structured_parses_response_and_returns_metadata(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("free_doc_extract.experimental.extract_glmocr.urlopen", fake_urlopen)
...
def test_extract_structured_rejects_missing_response_field(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "free_doc_extract.experimental.extract_glmocr.urlopen",
